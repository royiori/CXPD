...
MyPhysicsList::MyPhysicsList() : G4VModularPhysicsList(),
                                 fEMPhysicsList(0),
                                 fEMOptPhysicsList(0),
                                 fEMExtraPhysicsList(0),
                                 fDecayPhysicsList(0),
                                 fHadronElasticPhysicsList(0),
                                 fHadronInelasticPhysicsList(0),
                                 fStoppingPhysicsList(0),
                                 fIonPhysicsList(0),
                                 fNeutronPhysicsList(0)

{
    ...
    //fEMPhysicsList = new G4EmStandardPhysics(verbose);
    fEMPhysicsList = new MyPhysListEM("MyEMProc");
    ...
    fDecayPhysicsList = new G4DecayPhysics(verbose);
    ...
    //fNeutronPhysicsList = new G4NeutronTrackingCut(verbose);
...
MyPhysicsList::~MyPhysicsList()
{
    ...
    if (fEMOptPhysicsList != 0)
        delete fEMOptPhysicsList;
    if (fEMExtraPhysicsList != 0)
        delete fEMExtraPhysicsList;
